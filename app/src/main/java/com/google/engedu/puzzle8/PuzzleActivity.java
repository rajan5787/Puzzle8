...
public class PuzzleActivity extends ActionBarActivity {
    ...
    private CharSequence number_of_tiles[] = {"3*3","4*4","5*5"};
    int selectedTile = 0;
    int NUM_OF_TILES = 3;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            mAlertDialog.setTitle("Select Number of Tiles")
                        .setSingleChoiceItems(number_of_tiles, 1, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                selectedTile = which;
                            }
                        })
                    .setPositiveButton("OCKEY", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
